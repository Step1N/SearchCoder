...
<html>
   ...
   <body>
      ...
      <p>
      	Steps To run
      	<ul>
      		<li> Clone repo from git using  git clonehttps://github.com/Step1N/SearchCoder.git or Copy the source code</li>
      		<li> Build mvn clean install -DskipTests=true</li>
      		<li> Create xml in apache (E:\SearchCoderWS\apache-tomcat-6.0.43\conf\Catalina\localhost\) as searchCoder.xml</li>
